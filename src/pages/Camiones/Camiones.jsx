...
const Camiones = () => {
  ...
  const URLM = 'http://localhost:10101/settingsTruck';
  const URLAdd = 'http://localhost:10101/addTruck';
  const URLDelete = 'http://localhost:10101/deleteTruck';
  const URLEdit = 'http://localhost:10101/modifyTruck';
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 px-2">
          <form
            ...
            className="bg-[var(--Voscuro4)] p-6 rounded-lg shadow-lg w-full max-w-md text-white flex flex-col gap-4"
          >
