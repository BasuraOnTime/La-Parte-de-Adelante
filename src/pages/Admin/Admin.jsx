...
const Admin = () => {
  return (
   ...
   <section className='sectFirst glass p-[50px] place-items-center'>
    ...
    <div className='FontArial flex flex-col justify-center items-center gap-3.5 bg-[var(--Voscuro2)] w-120 h-100 rounded-4xl'>
        ...
        <button className='rounded-md w-100 h-10 bg-[var(--Vclaro)] text-white'> iniciar sesion </button>
    </div>
   </section>
   </>
  )
