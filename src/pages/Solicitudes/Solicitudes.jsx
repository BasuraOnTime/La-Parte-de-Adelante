...
const SolicitudForm = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[rgb(0,26,19)] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md p-8 bg-[#f9f8f4] border-[5px] border-black rounded-[40px] shadow-[8px_8px_0px_rgba(0,0,0,1)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-[rgb(204,238,200)] hover:bg-[rgb(204,238,80)] text-black font-bold py-3 px-6 rounded-full border-[3px] border-black shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all"
          >
            Enviar
          </button>
        </form>
...
const InputField = ({ label, name, type = "text", value, onChange }) => (
  <div className="flex flex-col">
    <label
      htmlFor={name}
      className="mb-1 text-base font-bold text-black drop-shadow-[1px_1px_0_rgba(0,0,0,0.7)]"
    >
      {label}
    </label>
    <input
